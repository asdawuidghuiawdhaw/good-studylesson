package com.hxkt.promotion;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.crypto.SecureUtil;
import cn.hutool.crypto.digest.HMac;
import com.hxkt.common.exceptions.BadRequestException;
import com.hxkt.promotion.utils.AESUtil;
import com.hxkt.promotion.utils.Base32;
import com.hxkt.promotion.utils.BitConverter;
...
public class EncryptTest {
    ...
    private AESUtil aesUtil = new AESUtil("hxkt-cloud-test-key-in", "hxkt-cloud-test-ivinit");
    @Test
    ...
    @Test
    void testCodeUtil() {
        CodeUtil codeUtil = new CodeUtil(new AESUtil("hxkt-cloud-test-key-in", "hxkt-cloud-test-ivinit"));
